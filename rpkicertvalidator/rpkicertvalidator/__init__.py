...
from .validate import validate_path, validate_tls_hostname, validate_usage, validate_ip_subnets
...
class CertificateValidator():
    ...
    def validate_tls(self, hostname):
        ...
        return self._path
    def validate_ip_subnets(self):
        """
        Validates the certificate path contains a correct delegation of networks down to the ROA certificate,
        so that you can't sign address space that hasn't been delegated to you
        ...
        """
        self._validate_path()
        validate_ip_subnets(self._context,self._certificate, self._path)
